...
public class ap7_iipsrv_docker {
    ...
    public void ap7_iipsrv_Status() {
        ...
        String containerName = "hbp_tapweb_iipsrv.1.5g4kvs6n2onf7vf406v8dulxy";

        System.out.println("ap7 iipsrv Docker Name = " + containerName);
        ...
        try {
            ...
            if (!isRunning) {
                sendEmailAlert("Hi,\n\n🚨 This is ap7 iipsrv Docker. I am currently down. Kindly restart the container at your earliest convenience.");
    ...
    public void sendEmailAlert(String messageBody) {
        ...
        String subject = "Docker Container Alert - ap7 iipsrv docker";
